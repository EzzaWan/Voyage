      ...
      content: (
        <div className="space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-[var(--voyo-muted)] ml-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-[var(--voyo-muted)] ml-4">
              ...
              <li>Then reinstall using the QR code or activation code from your Voyo account</li>
            </ul>
          </div>
          ...
          <div className="pt-4 border-t border-[var(--voyo-border)]">
            <Link href="/support?tab=install">
              <button className="text-[var(--voyo-accent)] hover:underline text-sm">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-[var(--voyo-muted)] ml-4">
              <li>Download the QR code image from your Voyo account</li>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-[var(--voyo-muted)] ml-4">
              ...
              <li>Review usage history in your Voyo account</li>
            </ul>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Link href="/support/device-check">
              <button className="px-4 py-2 bg-[var(--voyo-accent)] hover:bg-[var(--voyo-accent-soft)] text-white rounded-lg text-sm">
      ...
      {filteredItems.length === 0 ? (
        <Card className="bg-[var(--voyo-card)] border-[var(--voyo-border)]">
          <CardContent className="p-8 text-center">
            <p className="text-[var(--voyo-muted)]">No troubleshooting topics found matching your search.</p>
            <Link href="/support/contact" className="inline-block mt-4">
              <button className="text-[var(--voyo-accent)] hover:underline">
        ...
        <Accordion type="single" collapsible className="w-full">
          {filteredItems.map((item) => (
            <AccordionItem key={item.id} value={item.id} className="border-[var(--voyo-border)]">
              <AccordionTrigger className="text-white text-left hover:no-underline">
                {item.title}
              </AccordionTrigger>
              <AccordionContent>
                <Card className="bg-[var(--voyo-bg-light)] border-[var(--voyo-border)] mt-2">
