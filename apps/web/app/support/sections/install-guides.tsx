    ...
    <div className="space-y-6">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="iphone">
          ...
          <AccordionContent>
            <Card className="bg-[var(--voyo-bg-light)] border-[var(--voyo-border)] mt-4">
              <CardContent className="p-4 sm:p-6 space-y-6 md:space-y-8">
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--voyo-accent)] text-white flex items-center justify-center font-bold text-sm sm:text-base">1</div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-3 rounded-lg overflow-hidden border border-[var(--voyo-border)] w-full max-w-sm">
                          <Image
                    ...
                    {/* Step 2 */}
                    <div className="flex gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--voyo-accent)] text-white flex items-center justify-center font-bold text-sm sm:text-base">2</div>
                      <div className="flex-1 min-w-0">
                        <h4 className="text-white font-semibold mb-1">Scan QR Code</h4>
                        <p className="text-[var(--voyo-muted)] mb-2">
                          Select <strong className="text-white">Use QR Code</strong> and scan the code provided in your Voyo account.
                        </p>
                        {/* Add your images here - replace filenames with your actual image files */}
                        <div className="mt-3 space-y-3">
                          <div className="rounded-lg overflow-hidden border border-[var(--voyo-border)] w-full max-w-sm">
                            <Image
                          ...
                          <div className="rounded-lg overflow-hidden border border-[var(--voyo-border)] max-w-sm">
                            <Image
                    ...
                    {/* Step 3 */}
                    <div className="flex gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--voyo-accent)] text-white flex items-center justify-center font-bold text-sm sm:text-base">3</div>
                      <div className="flex-1 min-w-0">
                        <h4 className="text-white font-semibold mb-1">Label Your eSIM</h4>
                        <p className="text-[var(--voyo-muted)] mb-2">
                          Give your new eSIM a name like "Travel" or "Voyo" to identify it easily.
                        </p>
                      </div>
                    </div>
                    ...
                    {/* Step 4 */}
                    <div className="flex gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--voyo-accent)] text-white flex items-center justify-center font-bold text-sm sm:text-base">4</div>
                      <div className="flex-1 min-w-0">
                    ...
                    {/* Step 5 */}
                    <div className="flex gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--voyo-accent)] text-white flex items-center justify-center font-bold text-sm sm:text-base">5</div>
                      <div className="flex-1 min-w-0">
                        ...
                        <ul className="list-disc list-inside text-[var(--voyo-muted)] space-y-1 ml-1">
                ...
                <div className="w-full h-px bg-[var(--voyo-border)]"></div>

                {/* Method 2: Manual */}
                <div>
                  <h3 className="text-lg font-bold text-white mb-4">Method 2: Manual Entry (Alternative)</h3>
                  <div className="space-y-6">
                    <p className="text-[var(--voyo-muted)]">If you cannot scan the QR code, enter details manually.</p>
                    ...
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[var(--voyo-muted)] mb-3">
                          Copy the SM-DP+ Address and Activation Code from your Voyo account:
                        </p>
                        
                        <div className="space-y-3">
                          <div>
                            <span className="text-xs text-[var(--voyo-muted)] block mb-1">SM-DP+ Address</span>
                            <div className="bg-[var(--voyo-bg)] border border-[var(--voyo-border)] rounded-lg p-3 flex items-center justify-between">
                          ...
                          <div>
                            <span className="text-xs text-[var(--voyo-muted)] block mb-1">Activation Code</span>
                            <div className="bg-[var(--voyo-bg)] border border-[var(--voyo-border)] rounded-lg p-3 flex items-center justify-between">
                              <code className="text-sm text-white font-mono truncate mr-2">
                                {exampleAc}
                              </code>
                ...
                <div className="pt-4 border-t border-[var(--voyo-border)]">
                  <Link href="/support?tab=troubleshooting">
                    <Button variant="outline" className="border-[var(--voyo-border)] bg-[var(--voyo-bg-light)] text-white hover:bg-[var(--voyo-card)] hover:border-[var(--voyo-accent)] hover:text-white">
            ...
            <Card className="bg-[var(--voyo-bg-light)] border-[var(--voyo-border)] mt-4">
              <CardContent className="p-4 sm:p-6 space-y-6">
                <div className="space-y-4">
                  <div className="flex gap-3 sm:gap-4">
                    <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[var(--voyo-accent)] text-white flex items-center justify-center font-bold text-sm sm:text-base">
                      1
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <ol className="list-decimal list-inside space-y-2 text-[var(--voyo-muted)] ml-4">
                        ...
                        <li>Select <strong className="text-white">Scan QR code</strong> and scan the QR code from your Voyo account</li>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <ol className="list-decimal list-inside space-y-2 text-[var(--voyo-muted)] ml-4">
                        ...
                        <li>Scan the QR code from your Voyo account</li>
                      </ol>
                    </div>
                  </div>
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 mt-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-[var(--voyo-muted)] space-y-1">
