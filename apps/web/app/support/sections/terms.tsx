    ...
    <Card className="bg-[var(--voyo-card)] border-[var(--voyo-border)]">
      <CardContent className="p-8 space-y-8">
        ...
        <div className="space-y-6">
          <section>
            ...
            <div className="text-[var(--voyo-muted)] space-y-2 ml-4">
              <p><strong className="text-white">"Voyo"</strong> refers to our eSIM marketplace platform and services.</p>
          ...
          <section>
            ...
            <div className="text-[var(--voyo-muted)] space-y-2 ml-4">
              <p>• Voyo provides eSIM services "as is" without warranties of any kind.</p>
          ...
          <section>
            ...
            <div className="text-[var(--voyo-muted)] space-y-2 ml-4">
              ...
              <p>• Support: <a href="/support/contact" className="text-[var(--voyo-accent)] hover:underline">Contact Form</a></p>
        ...
        <div className="pt-6 border-t border-[var(--voyo-border)]">
          <p className="text-[var(--voyo-muted)]">
            By using Voyo services, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
          </p>
        </div>
      </CardContent>
    </Card>
